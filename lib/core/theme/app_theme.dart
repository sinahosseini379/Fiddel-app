...
import 'package:fiddel/core/theme/app_theme_mode.dart';
...
class AppTheme {
  ...
  ThemeData lightTheme(ColorScheme? lightColorScheme) {
    final ColorScheme scheme = lightColorScheme ?? ColorScheme.fromSeed(seedColor: const Color(0xFFC39B2F));
    return ThemeData(
      useMaterial3: true,
      colorScheme: scheme,
  ...
  ThemeData darkTheme(ColorScheme? darkColorScheme) {
    final ColorScheme scheme =
        darkColorScheme ?? ColorScheme.fromSeed(seedColor: const Color(0xFFC39B2F), brightness: Brightness.dark);
    return ThemeData(
      useMaterial3: true,
      colorScheme: scheme,
