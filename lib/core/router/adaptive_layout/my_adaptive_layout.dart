...
import 'package:fiddel/core/router/adaptive_layout/shell_route_action.dart';
import 'package:fiddel/core/router/go_router/helper/active_breakpoint_notifier.dart';
import 'package:fiddel/core/router/go_router/routing_config_notifier.dart';
import 'package:fiddel/features/stats/widget/side_bar_stats_overview.dart';
...
class MyAdaptiveLayout extends HookConsumerWidget {
  ...
  List<ShellRouteAction> _actions(Translations t, bool showProfilesAction, bool isMobileBreakpoint) => [
    ...
    ShellRouteAction(Icons.science_rounded, t.pages.fiddelTester.title),
